 ...
 * <p>
 * ripped from here: http://thesoftwarelife.blogspot.com/2009/10/java-immutable-persistent-list.html
 * licensed with GPL http://www.suneido.com/faq/open-source-license
 */
@Immutable
public class PersistentList<T> extends AbstractSequentialList<T> {
  ...
  public static <T> PersistentList<T> copyOf(Iterable<T> values) {
    if (values instanceof PersistentList) return (PersistentList<T>) values;
